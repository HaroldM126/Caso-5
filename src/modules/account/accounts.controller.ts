...
export class AccountsController {
  ...
  @ApiOperation({
    ...
    description: 'Retorna unicamente el saldo actual de la cuenta del usuario autenticado.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Retorna la cuenta asociada a un usuario especifico por su ID.',
  })
